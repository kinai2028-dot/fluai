...
st.markdown(
    ...
    <div style='text-align: center; color: #666;'>
        ...
        🧪 模型可用性測試 | 🎯 智能推薦 | ⚡ 響應時間優化 | 🔄 自動重試<br>
        支持多種 API 提供商 | 由 Black Forest Labs 技術驅動
    </div>
    """,
...
# 自動顯示模型測試（如果從側邊欄觸發）
if hasattr(st.session_state, 'show_model_test') and st.session_state.show_model_test:
    st.session_state.show_model_test = False
    # 自動切換到模型測試標籤
    st.info("💡 請切換到 '模型測試' 標籤查看詳細結果")
